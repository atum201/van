...
var standardDoc = exports.standardDoc = function standardDoc(doc) {
  var result = _lodash2.default.clone(doc);
  result.id = doc._id;
  delete result._id;
...
var emitter = exports.emitter = function emitter(dest, action, payload) {};
